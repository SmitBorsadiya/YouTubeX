...
const Video = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const videoResp = await axios.get(`http://localhost:5000/api/videos/find/${path}`)
                const channelResp = await axios.get(`http://localhost:5000/api/users/find/${videoResp.data.UserId}`)
